...
export default function StudentOnboardingPage() {
  ...
  const breadcrumbs = [{ label: 'Trang chủ', href: '/' }, { label: 'Onboarding' }];
  ...
  return (
    <>
      <StudentHeader breadcrumbs={breadcrumbs} />
      <div className="custom-scrollbar mx-auto w-full max-w-7xl flex-1 overflow-y-auto px-4 py-4 sm:px-6 sm:py-6">
