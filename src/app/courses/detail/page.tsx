  ...
  return (
    <div className="flex h-screen w-full overflow-hidden bg-[#f8fafc] text-sm text-slate-700">
      ...
      <main className="relative flex h-screen min-w-0 flex-1 flex-col overflow-hidden">
        ...
        <div
          className="custom-scrollbar relative flex-1 overflow-y-auto scroll-smooth"
          id="mainScrollArea"
        >
          {/* 1. HERO BANNER */}
          <HeroBanner />
                ...
                <div className="card flex items-start gap-5 border border-gray-200 p-5">
                  ...
                  <div>
                    ...
                    <p className="mb-3 text-[13px] leading-relaxed text-slate-600">
                      ...
                      trúc lõi cho hệ thống xử lý 50 triệu giao dịch/ngày. Hiện đang phụ trách đào
                      tạo khối Engineering.
                    </p>
