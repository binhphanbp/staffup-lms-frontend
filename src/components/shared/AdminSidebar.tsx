...
export const AdminSidebar = () => {
  ...
  const isManager = user?.roleCodes?.includes('manager') ?? false;
  const isTrainer = user?.roleCodes?.includes('trainer') ?? false;
  const isTrainerOnly = isTrainer && !isAdmin && !isManager;
  ...
  return (
    <aside className="z-100 flex h-full w-65 shrink-0 flex-col border-r border-[#DADCE0] bg-white dark:border-slate-800 dark:bg-slate-900">
      ...
      <div className="custom-scrollbar flex-1 overflow-y-auto py-3">
        {/* Tổng quan Hệ thống — admin/manager only */}
        {!isTrainerOnly && (
        ...
        {/* Phân hệ Học viên — admin/manager only */}
        {!isTrainerOnly && (
          <div className="mb-2 border-b border-[#DADCE0] pb-2 dark:border-slate-800">
            <div className="flex items-center gap-2 px-6 py-3 text-[12px] font-medium tracking-[0.8px] text-[#5F6368] uppercase dark:text-slate-500">
              Phân hệ Học viên
            ...
            >
              <span className="material-symbols-outlined mr-4 text-[20px]">school</span> Danh sách
              Học viên
            </Link>
            <Link
        ...
        {/* Phân hệ Giảng viên — visible to trainer too */}
        <div className="mb-2 border-b border-[#DADCE0] pb-2 dark:border-slate-800">
          <div className="flex items-center gap-2 px-6 py-3 text-[12px] font-medium tracking-[0.8px] text-[#5F6368] uppercase dark:text-slate-500">
            Phân hệ Giảng viên
          </div>
          {!isTrainerOnly && (
            <>
              ...
              >
                <span className="material-symbols-outlined mr-4 text-[20px]">co_present</span> Danh
                sách Giảng viên
              </Link>
              <Link
              ...
              >
                <span className="material-symbols-outlined mr-4 text-[20px]">menu_book</span> Quản
                lý Khóa học
              </Link>
            </>
          )}
        ...
        {/* Hệ thống & AI — admin/manager only */}
        {!isTrainerOnly && (
          <div className="mb-2 border-b border-[#DADCE0] pb-2 dark:border-slate-800">
            <div className="flex items-center gap-2 px-6 py-3 text-[12px] font-medium tracking-[0.8px] text-[#5F6368] uppercase dark:text-slate-500">
              Hệ thống & AI
